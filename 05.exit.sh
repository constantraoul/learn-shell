...
# Any value between 0-255 can be used by scripting person, however values from 125+ (126-255) are being used by system.
# so we usually don't use those values as author script and we are free to use from 0-125